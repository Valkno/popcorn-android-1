...
public interface PreferencesHandler {
    ...
    class ItemsGenerator {
        ...
        public static List<PrefItem> generate(final Context context, final PreferencesHandler handler, boolean isTV) {
            ...
            //final String[] items = {context.getString(R.string.title_shows), context.getString(R.string.title_anime)};
            ...
            prefItems.add(PrefItem.newBuilder(context)
                    ...
                    .setPreferenceKey(PopcornUpdater.LAST_UPDATE_CHECK)
                    .setDefaultValue(1)
                    .setOnClickListener(new PrefItem.OnClickListener() {
                        @Override
                        public void onClick(final PrefItem item) {
                            PopcornUpdater.getInstance(context).checkUpdatesManually();
                        }
                    })
                    .setSubtitleGenerator(new PrefItem.SubtitleGenerator() {
                        @Override
                        public String get(PrefItem item) {
                            long timeStamp = Long.parseLong(PrefUtils.get(context, PopcornUpdater.LAST_UPDATE_CHECK, "0"));
